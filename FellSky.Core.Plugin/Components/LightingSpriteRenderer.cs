...
namespace FellSky.Components
{
	...
	public class LightingSpriteRenderer : SpriteRenderer
	{
		...
		protected void PrepareVerticesLight(ref VertexDynamicLighting[] vertices, IDrawDevice device, ColorRgba mainClr, Rect uvRect, bool perPixel)
		{
		...
		public override void Draw(IDrawDevice device)
		{
			...
			this.PrepareVerticesLight(ref this.verticesLight, device, this.colorTint, uvRect, true);
